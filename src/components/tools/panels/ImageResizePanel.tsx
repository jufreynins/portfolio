  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-6 lg:grid lg:grid-cols-[280px_1fr_300px] lg:items-start lg:gap-6">
        ...
        {/* Center: dimensions readout + dominant crop preview */}
        ...
        {/* Mode + size controls */}
        <div className="order-3 flex flex-col gap-4 rounded-2xl border p-5 sm:p-6 lg:col-start-1 lg:row-start-2" style={{ borderColor: 'var(--border-color)' }}>
        ...
        <div className="order-4 flex flex-col gap-6 lg:col-start-3 lg:row-start-1 lg:row-span-2">
          ...
          <div className="hidden grid-cols-2 gap-4 rounded-2xl border p-4" style={{ borderColor: 'var(--border-color)', background: 'var(--surface-warm)' }} data-summary>
            <div className="flex flex-col gap-1">
              ...
              <span className="text-lg font-bold" style={{ color: 'var(--text-primary)' }} data-summary-count>0</span>
            </div>
            <div className="flex flex-col gap-1">
              <span className="text-xs font-medium" style={{ color: 'var(--text-secondary)' }}>Resized</span>
              <span className="text-lg font-bold" style={{ color: 'var(--text-primary)' }} data-summary-converted>0</span>
            </div>
            <div className="flex flex-col gap-1">
              <span className="text-xs font-medium" style={{ color: 'var(--text-secondary)' }}>Original size</span>
              <span className="text-lg font-bold" style={{ color: 'var(--text-primary)' }} data-summary-original-size>—</span>
            </div>
            <div className="flex flex-col gap-1">
              <span className="text-xs font-medium" style={{ color: 'var(--text-secondary)' }}>New size</span>
              <span className="text-lg font-bold" style={{ color: 'var(--text-primary)' }} data-summary-converted-size>—</span>
            </div>
            <div className="col-span-2 flex flex-col gap-1">
              <span className="text-xs font-medium" style={{ color: 'var(--text-secondary)' }}>Total saved</span>
              <span className="text-lg font-bold" style={{ color: 'var(--tool-accent)' }} data-summary-saved>—</span>
            </div>
          </div>
