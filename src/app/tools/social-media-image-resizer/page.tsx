...
import { SOCIAL_PRESETS, ANCHOR_POSITIONS } from '@/lib/imageResize/utils';
...
const infoCards = [
  ...
  },
  {
    ...
    body: 'When your image’s aspect ratio doesn’t match the platform’s, this tool crops to fit instead of distorting it. Choose which part of the image to keep with the anchor grid.',
  },
  {
            ...
            <div className="order-1 flex flex-col gap-6 lg:order-2 lg:sticky lg:top-28">
              ...
              <div className="flex flex-col gap-4 rounded-2xl border p-5 sm:p-6" style={{ borderColor: 'var(--border-color)' }}>
                ...
                <div className="inline-flex w-fit flex-wrap gap-1 rounded-full border p-1" style={{ borderColor: 'var(--border-color)', background: 'var(--surface-warm)' }} role="group" aria-labelledby="resize-mode-label">
                  ...
                  <button type="button" data-mode-btn data-mode="preset" aria-pressed="true" className="min-h-[40px] rounded-full px-4 text-sm font-bold transition-all duration-200" style={{ background: 'var(--brand-primary)', color: '#ffffff' }}>
                    Presets
                  </button>
                </div>
